 ...
 * - We want the UI to be able to call an external backend (running on `192.168.2.6:9092`)
 ...
 * - Example values:
 *   - `VITE_ANOMALY_API_BASE_URL=http://192.168.2.6:9092/anomaly`
 *   - `VITE_ANOMALY_API_BASE_URL=http://192.168.2.6:9092`
 */
...
const DEFAULT_ANOMALY_API_BASE_URL = "http://192.168.2.6:9092";
